...
class categoryClass:
    def __init__(self, root):
        ...
        # ==========tittle===========
        lbl_tittle = Label(self.root, text="Manage Product Category", font=(
        ...
        # ====image1====
        self.im1 = Image.open("images/text1.png")
        self.im1 = self.im1.resize((500, 250), Image.ANTIALIAS)
        self.im1 = ImageTk.PhotoImage(self.im1)

        self.lbl_im1 = Label(self.root, image=self.im1, bd=2, relief=RAISED)
        self.lbl_im1.place(x=310, y=220)

        # ====image2====
        # self.im2 = Image.open("images/text.jpg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "":
                ...
                if row != None:
                    messagebox.showerror(
                        "error", "category alreday exits,try another", parent=self.root)
                else:
                    ...
                    con.commit()
                    messagebox.showinfo(
                        "success", "actegory added successfully", parent=self.root)
                    self.show()
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get() == "":
                messagebox.showerror(
                    "error", "category name number must be required", parent=self.root)
            else:
                ...
                if row == None:
                    ...
                    if op == True:
                        ...
                        con.commit()
                        messagebox.showinfo(
                            "delelte", "category deleted successfully", parent=self.root)
                        self.show()
                        self.var_cat_id.set("")
                        self.var_name.set("")
